    ...
    const frame = window.requestAnimationFrame(() => {
      ...
      if (!before) {
        ...
        if (settings.grain > 0) {
          ...
          ctx.beginPath()
          for (let index = 0; index < count; index += 1) { seed = (seed * 9301 + 49297) % 233280; const x = seed / 233280 * canvas.width; seed = (seed * 9301 + 49297) % 233280; const y = seed / 233280 * canvas.height; ctx.rect(x, y, size, size) }
          ctx.fill()
          ctx.restore()
        }
