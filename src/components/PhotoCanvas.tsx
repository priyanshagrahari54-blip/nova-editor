    ...
    const frame = window.requestAnimationFrame(() => {
      ...
      if (!before) {
        ...
        if (settings.grain > 0) {
          ...
          // Batch up to 8,000 grain rectangles into a single path and issue a single ctx.fill() call per frame.
          // Replaces 8,000 individual ctx.fillRect() API dispatches with 1 fill dispatch, reducing per-frame grain render overhead.
