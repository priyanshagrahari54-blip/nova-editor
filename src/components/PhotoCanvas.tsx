    ...
    const frame = window.requestAnimationFrame(() => {
      ...
      if (!before) {
        ...
        if (settings.grain > 0) {
          ...
          // Batch up to 8,000 grain particle rects into a single path call (`ctx.beginPath() ... ctx.fill()`)
          // instead of calling `ctx.fillRect()` repeatedly. This avoids thousands of canvas draw call overheads per frame.
